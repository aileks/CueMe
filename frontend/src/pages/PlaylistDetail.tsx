...
export default function PlaylistDetail() {
  ...
  return (
    <div className='mx-auto max-w-4xl'>
      <div className='mb-6'>
        <Link to='/playlists' className='inline-flex neu-button items-center gap-2'>
          <ArrowLeft size={16} />
          Back to Playlists
        </Link>
      </div>
      ...
      <div className='mb-6 neu-card'>
        ...
        <p className='py-8 text-center text-muted-foreground'>This playlist is coming soon!</p>
